        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                for j, context in enumerate(context_list_choose):
                    ...
                    # print(f"noisy_latents:{control_model_input.shape}")
                    # print(f"timesteps:{t}")
                    # print(f"brushnet_prompt_embeds:{brushnet_prompt_embeds.shape}")
                    # print(f"brushnet_cond:{brushnet_cond.shape}")
                    # noisy_latents:torch.Size([22, 4, 60, 144])
                    # timesteps:949
                    # brushnet_prompt_embeds:torch.Size([22, 77, 768])
                    # brushnet_cond:torch.Size([22, 5, 60, 144])
                    ...
                    # latents:torch.Size([22, 4, 60, 144])
                    # timesteps:849
                    # prompt_embeds:torch.Size([1, 77, 768])
                    # down_block_res_samples:12,torch.Size([22, 320, 60, 144])
                    # mid_block_res_sample:torch.Size([22, 1280, 8, 18])
                    # up_block_res_samples:15,torch.Size([22, 1280, 8, 18])
                    # timestep_cond:None
